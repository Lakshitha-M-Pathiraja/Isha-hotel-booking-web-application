...
<nav class="navbar navbar-expand-lg bg-light px-lg-3 py-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">ISHA HOTEL</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" class="nav-link me-2" aria-current="page" href="index.php">Home</a>
        </li>
        <li class="nav-item">
      ...
      <div class="d-flex" role="search">
          <!-- <a class="nav-link me-2" href="login.php">Login</a>&nbsp -->
		  <a class="nav-link me-2"  href="signup.php">Register</a>

		  <?php
 			if(isset($_SESSION["username"])){ 
    		echo '<a href="includes/logout.inc.php" class="nav-link me-2"> Logout</a>';
    		echo '<a href="profile.php" class="nav-link me-2" >'.$_SESSION["username"] . ' ! </a>';
 			}
 		else
 			{
   			 echo '<a href="login.php" class="nav-link me-2">Login</a></li>';
			 }
 		 ?>
      </div>
