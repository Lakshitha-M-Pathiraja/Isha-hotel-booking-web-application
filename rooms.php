...
<div class="col-lg-9 col-md-12 px-4">
  ...
  <div class="row g-0 p-3 align-items-center">
    ...
    <div class="col-md-5 px-lg-3 px-md-3 px-0">
      <h5 class="mb-3"><h5><u>Standard Double Room(Type1)</u></h5>
      <h6 class="mb-4"> </h6>
    ...
    <div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
      ...
      <a href="index.php" class="btn btn-sm w-100 text-white custom-bg shadow-none mb-2">Book Now</a>
      <a href="about.php" class="btn btn-sm w-100 btn-outline-dark shadow-none">More details</a>
    </div>
  </div>
 </div>
 <div class="card mb-4 border-0 shadow">
  <div class="row g-0 p-3 align-items-center">
    ...
    <div class="col-md-5 px-lg-3 px-md-3 px-0">
      <h5 class="mb-3"><u>Standard Triple Room(Type2)</u></h5>
      <div class="features mb-4">
            <h6 class="mb-1">Features</h6>
            <span class="badge rounded-pill bg-light text-dark text-wrap">
             3 single beds
...
<div class="card mb-4 border-0 shadow">
  <div class="row g-0 p-3 align-items-center">
    ...
    <div class="col-md-5 px-lg-3 px-md-3 px-0">
      <h5 class="mb-3"><u>Duluxe Family Room(Type3)</u></h5>
      <div class="features mb-4">
            <h6 class="mb-1">Features</h6>
            <span class="badge rounded-pill bg-light text-dark text-wrap">
